...
docker compose -f "${COMPOSE_FILE}" --env-file "${COMPOSE_ENV_FILE}" stop axis_server
docker compose -f "${COMPOSE_FILE}" --env-file "${COMPOSE_ENV_FILE}" rm -f axis_server
...
docker compose -f "${COMPOSE_FILE}" --env-file "${COMPOSE_ENV_FILE}" up -d axis_server
