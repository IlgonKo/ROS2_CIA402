...
load_env() {
  ...
  ISOLATED_CPUS="${PYSOEM_HOST_ISOLATED_CPUS:-${PYSOEM_AXIS_SERVER_CPUSET:-6}}"
  HOUSEKEEPING_CPUS="${PYSOEM_HOST_HOUSEKEEPING_CPUS:-0-5,7}"
}
...
status_isolation() {
  ...
  echo "  PYSOEM_AXIS_SERVER_CPUSET=${PYSOEM_AXIS_SERVER_CPUSET:-}"
  echo "  PYSOEM_HOST_ISOLATED_CPUS=${PYSOEM_HOST_ISOLATED_CPUS:-${PYSOEM_AXIS_SERVER_CPUSET:-6}}"
  echo "  PYSOEM_HOST_HOUSEKEEPING_CPUS=${PYSOEM_HOST_HOUSEKEEPING_CPUS:-0-5,7}"
  echo ""
