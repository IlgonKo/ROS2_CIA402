...
load_env() {
  ...
  ISOLATED_CPUS="${AXIS_SERVER_ISOLATED_CPUS:-${AXIS_SERVER_CPUSET:-6}}"
  HOUSEKEEPING_CPUS="${AXIS_SERVER_HOUSEKEEPING_CPUS:-0-5,7}"
}
...
status_isolation() {
  ...
  echo "  AXIS_SERVER_CPUSET=${AXIS_SERVER_CPUSET:-}"
  echo "  AXIS_SERVER_ISOLATED_CPUS=${AXIS_SERVER_ISOLATED_CPUS:-${AXIS_SERVER_CPUSET:-6}}"
  echo "  AXIS_SERVER_HOUSEKEEPING_CPUS=${AXIS_SERVER_HOUSEKEEPING_CPUS:-0-5,7}"
  echo ""
