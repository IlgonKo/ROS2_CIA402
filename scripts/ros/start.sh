...
grep -E '^(MOTION_SERVER_HOST|MOTION_SERVER_PORT|ROS_BRIDGE_AUTO_REQUEST_AUTHORITY|PYSOEM_BUS|ROS2_CIA402_AXIS_NAMES|PYSOEM_CSP_COUNTS_PER_UNIT)=' "${COMPOSE_ENV_FILE}" || true
