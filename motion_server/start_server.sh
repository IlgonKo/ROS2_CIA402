...
BACKEND="${MOTION_SERVER_BACKEND:-${AXIS_SERVER_BACKEND:-pysoem}}"
SERVER_MODE="${MOTION_SERVER_MODE:-${AXIS_SERVER_MODE:-basic}}"
BUS="${MOTION_SERVER_BUS:-${PYSOEM_BUS:-cmmt}}"
PORT="${MOTION_SERVER_PORT:-${AXIS_SERVER_PORT:-15000}}"
CYCLE_TIME="${PYSOEM_CYCLE_TIME:-0.01}"
SPIN_WAIT_TIME="${PYSOEM_SPIN_WAIT_TIME:-0.00015}"
CPUSET="${MOTION_SERVER_CPUSET:-${AXIS_SERVER_CPUSET:-}}"
...
MAX_VELOCITY="${MOTION_SERVER_MAX_VELOCITY:-${PYSOEM_MAX_VELOCITY:-50.0}}"
ACCELERATION="${MOTION_SERVER_ACCELERATION:-${PYSOEM_ACCELERATION:-100.0}}"
DECELERATION="${MOTION_SERVER_DECELERATION:-${PYSOEM_DECELERATION:-100.0}}"
JERK="${MOTION_SERVER_JERK:-${PYSOEM_JERK:-1000.0}}"
PP_JERK="${MOTION_SERVER_PP_JERK:-${PYSOEM_PP_JERK:-100000}}"
CSP_COUNTS_PER_UNIT="${MOTION_SERVER_CSP_COUNTS_PER_UNIT:-${PYSOEM_CSP_COUNTS_PER_UNIT:-1.0}}"
CSP_PROFILE="${MOTION_SERVER_CSP_PROFILE:-${PYSOEM_CSP_PROFILE:-quintic}}"
CSP_INTERPOLATION_MODE="${MOTION_SERVER_CSP_INTERPOLATION_MODE:-${PYSOEM_CSP_INTERPOLATION_MODE:-1}}"
CSP_VELOCITY_OFFSET="${MOTION_SERVER_CSP_VELOCITY_OFFSET:-${PYSOEM_CSP_VELOCITY_OFFSET:-0}}"
DERIVED_VELOCITY_ALPHA="${MOTION_SERVER_DERIVED_VELOCITY_ALPHA:-${PYSOEM_DERIVED_VELOCITY_ALPHA:-0.2}}"
MOTION_MODE="${MOTION_SERVER_MOTION_MODE:-${PYSOEM_MOTION_MODE:-pp}}"
COMMAND_LOGS="${MOTION_SERVER_COMMAND_LOGS:-${AXIS_SERVER_COMMAND_LOGS:-0}}"
STATUS_LOGS="${MOTION_SERVER_STATUS_LOGS:-${AXIS_SERVER_STATUS_LOGS:-0}}"
