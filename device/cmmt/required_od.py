...
CMMT_REQUIRED_OD = {
    ...
    for item in (
        ...
        od("position_window", 0x6067, 0x00, "Position window", "uint32", "rw", 20),
        od(
        ...
        od("profile_velocity", 0x6081, 0x00, "Profile velocity", "uint32", "rw"),
        od(
        ...
        od("homing_method", 0x6098, 0x00, "Homing method", "int8", "rw", 35),
        od(
        ...
        od("max_acceleration", 0x60C5, 0x00, "Max acceleration", "uint32", "rw"),
        od("max_deceleration", 0x60C6, 0x00, "Max deceleration", "uint32", "rw"),
        od("pp_jerk", 0x60A4, 0x01, "Jerk", "uint32", "rw", 100000),
        od(
        ...
        od("sync_mode", 0x212E, 0x01, "Synchronisation mode", "uint16", "rw"),
        od("sync_cycle_time", 0x212E, 0x02, "Cycle time", "float32", "rw"),
        od(
        ...
        od("device_reset_command", 0x2000, 0x01, "Reset device control", "uint8", "rw"),
        od(
        ...
        od("error_code", 0x2145, 0x0C, "CMMT most serious error", "uint32", "ro"),
    )
}
